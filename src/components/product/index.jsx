...
const Product = () => {
  ...
  // Set selectedNumber based on the cart state if the item is in the cart
  useEffect(() => {
    if (isInCart) {
...
//   return (
//     <div className={styles.productDetails}>
//       <ProductImage imageUrl={card.url} />
//       <ProductInfo
//         card={card}
//         isInCart={isInCart}
...
//   formattedDate,
// }) => {
//   const items = [<ShippingFeeDetails key="1" card={card} />];
//   const items1 = [<ExtraSavingDetails key="11" />];

//   return (
//     <div className={styles.productInfo}>
//       <ProductHeader card={card} />
//       <ProductPricing card={card} items={items} items1={items1} />
//       <Specifications card={card} />
//       <AboutSection card={card} />
//       <ProductNote note={card.note} />
//       <AddToCartSection
//         card={card}
//         isInCart={isInCart}
//         isUpdateMode={isUpdateMode}
...
// const ProductPricing = ({ card, items, items1 }) => (
//   <div className={styles.secondSec}>
//     <p className={styles.discountPrice}>
//       <span style={{ color: "rgb(239, 63, 63)" }}>- {card.discount}</span>
//       <span>
...
//         {showAll ? (
//           <>
//             <IoIosArrowUp /> Show Less
//           </>
//         ) : (
//           <>
//             <IoIosArrowDown /> Show More
//           </>
//         )}
//       </button>
//     </div>
...
//     />
//     <ExtraInformation card={card} formattedDate={formattedDate} />
//   </form>
// );

// const ExtraInformation = ({ card, formattedDate }) => (
//   <div className={styles.extraInformation}>
//     <p>
//       <span>Ships from</span>
//       <span>Amazon.com</span>
...
//     <span>Buy New :</span>
//     <p className={styles.shipp}>
//       ${card.shipping.cost} Shipping & Import Fees Deposit to Germany Details
//       <br />
//       <span>Delivery</span>
//       <em>{formattedDate}</em>
//     </p>
